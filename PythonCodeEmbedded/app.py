...
class View:
    ...
    def second_view(self):
        ...
        canvas = create_canvas(self.second_screen, width=1920, height=1080).pack()
        ...
        self.sensor = canvas.create_rectangle(
            self.entry1 * 180 / 2 + 395, self.entry2 * 180 / 2 + 45, self.entry1 * 180 / 2 + 405,
    ...
    def furniture_function(self, canvas, fill, active_fill, top_left, top_right, bottom_left, bottom_right):
        ...
        canvas.tag_bind(list_of_globals['active'], '<Double-1>', partial(on_click, canvas))
    ...
    def update_screen(self, original_canvas):
        ...
        self.update_canvas = create_canvas(self.update, width=1920, height=1080)
